...
namespace Hzeff.Editor
{
    ...
    public class RecyclableScrollRectEditor : UnityEditor.Editor
    {
        ...
        RecycleScrollRect _script;

        protected virtual void OnEnable()
        {
            _script = (RecycleScrollRect)target;
            ...
            //Inherited
            _protoTypeCell = serializedObject.FindProperty("PrefabItem");
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (_type.boolValue)
            {
                string title = _direction.enumValueIndex == (int)RecycleScrollRect.DirectionType.Vertical
                    ? "Columns"
                    : "Rows";
